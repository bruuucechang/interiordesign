...
MODELS = {
    ...
    # 第三批：多給幾種風格——彩繪鄉村、工業、古典、中式、金屬。全部實掃。
    'chair_painted':      'painted_wooden_chair_01',
    'chair_country':      'painted_wooden_chair_02',
    'chair_school':       'SchoolChair_01',
    'chair_plastic':      'plastic_monobloc_chair_01',
    'chair_arm_wood':     'gallinera_chair',
    'cn_stool':           'chinese_stool',
    'stool_low':          'metal_stool_02',
    'stool_tall':         'metal_stool_03',
    'stool_bar_round':    'bar_chair_round_01',
    'stool_painted':      'painted_wooden_stool',
    'chair_swivel':       'BarberShopChair_01',
    'sofa_painted':       'painted_wooden_sofa',
    'cn_sofa':            'chinese_sofa',
    'coffee_big':         'CoffeeTable_01',
    'coffee_square':      'modern_coffee_table_02',
    'coffee_classic':     'gothic_coffee_table',
    'coffee_industrial':  'industrial_coffee_table',
    'table_round_small':  'round_wooden_table_02',
    'table_painted':      'painted_wooden_table',
    'table_wood2':        'wooden_table_02',
    'table_small':        'small_wooden_table_01',
    'table_low':          'gallinera_table',
    'desk_school':        'SchoolDesk_01',
    'side_tiny':          'WoodenTable_02',
    'console_wood':       'WoodenTable_03',
    'cabinet_classic':    'GothicCabinet_01',
    'nightstand_painted': 'painted_wooden_nightstand',
    'shelf_wide':         'steel_frame_shelves_03',
    'rack_metal':         'worn_metal_rack',
    'cart_storage':       'industrial_storage_cart',
    'cn_commode':         'chinese_commode',
    'bed_classic':        'GothicBed_01',
    'bed_frame':          'old_bed_frame',
}
