...
export const FURNITURE: FurnitureItem[] = [
  ...
  { id: 'nightstand', name: '床頭櫃', cat: '臥室', w: 45, h: 40, draw(ctx, w, h) { cabinet(ctx, w, h, 1); } },
  // 廚房
  ...
  { id: 'bookshelf', name: '書櫃', cat: '書房', w: 100, h: 35, draw(ctx, w, h) { cabinet(ctx, w, h, 4); } },
];
...
const PRICES: Record<string, number> = {
  ...
  cabinet_storage: 7000, plant: 1200,
  dining: 9000, chair: 2500, cabinet_side: 10000,
  bed_double: 22000, bed_single: 14000, wardrobe: 12000, nightstand: 3500,
  stove: 15000, fridge: 20000, sink: 6000, cabinet_kitchen: 25000,
  toilet: 5000, bathtub: 18000, shower: 12000, vanity: 9000,
  desk: 5000, bookshelf: 8000,
};
