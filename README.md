...
npm run assets       # 選配：抓 CC0 家具模型（約 41MB，跑一次就好）
...
目錄共 **251 件**，其中 27 件（14 款衣櫃 ＋ 13 件日式／北歐）是程式蓋的，不需要
下載也一樣完整——實掃圖庫沒有第二個衣櫃，也沒有和室家具。模型來自四個 CC0 來源：
Poly Haven（實掃）、Quaternius、Sweet Home 3D 的 Blend Swap CC-0 素材庫、Kenney。
